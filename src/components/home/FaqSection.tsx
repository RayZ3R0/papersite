...
const faqs = [
  {
    ...
    answer: "You can use the search bar at the top of the page to find papers by subject, unit, session, or year. You can also use filters to narrow down your search results."
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answer: "We update our database regularly as new papers become available. The most recent papers are typically added within a few days of their release."
  },
  {
    id: 4,
    question: "Can I download papers for offline use?",
    answer: "Yes, all papers can be downloaded as PDF files for offline use. Simply click on the paper link and it will open in a new tab where you can download it."
  },
  {
    id: 5,
    question: "What subjects are available?",
    answer: "We currently offer papers for Chemistry, Physics, Biology, Mathematics, Economics, Business Studies, and Accounting. We're constantly expanding our collection."
  }
];
