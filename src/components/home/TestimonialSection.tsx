...
const testimonials = [
  {
    id: 1,
    text: "PaperNexus has been an incredibly helpful resource for my A-Level studies. The search feature makes finding past papers so much easier!",
    author: "Alex K.",
    role: "A-Level Student",
  },
  {
    id: 2,
    text: "As a teacher, I recommend PaperNexus to all my students. The organized collection of papers and mark schemes has improved our exam preparation.",
    author: "Sarah M.",
...
export default function TestimonialSection() {
  ...
  return (
    <section ref={sectionRef} className="w-full py-20 md:py-24 bg-surface">
      <div className="max-w-5xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-text-muted max-w-xl mx-auto">
            Hear from students and teachers who use PaperNexus
          </p>
        </motion.div>
